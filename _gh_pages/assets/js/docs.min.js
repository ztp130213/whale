 ...
 */
!function(a){"use strict";a(function(){var b=a(window),c=a(document.body);c.scrollspy({target:".bs-docs-sidebar"}),b.on("load",function(){c.scrollspy("refresh")}),a('.bs-docs-container [href="#"]').click(function(a){a.preventDefault()}),setTimeout(function(){var b=a(".bs-docs-sidebar");b.affix({offset:{top:function(){var c=b.offset().top,d=parseInt(b.children(0).css("margin-top"),10),e=a(".bs-docs-nav").height();return this.top=c-e-d},bottom:function(){return this.bottom=a(".bs-docs-footer").outerHeight(!0)}}})},100),setTimeout(function(){a(".bs-top").affix()},100),function(){var b=a("#bs-theme-stylesheet"),c=a(".bs-docs-theme-toggle"),d=function(){b.attr("href",b.attr("data-href")),c.text("Disable theme preview"),localStorage.setItem("previewTheme",!0)};localStorage.getItem("previewTheme")&&d(),c.click(function(){var a=b.attr("href");a&&0!==a.indexOf("data")?(b.attr("href",""),c.text("Preview theme"),localStorage.removeItem("previewTheme")):d()})}(),a(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"}),a(".popover-demo").popover({selector:'[data-toggle="popover"]',container:"body"}),a(".tooltip-test").tooltip(),a(".popover-test").popover(),a(".bs-docs-popover").popover(),a("#loading-example-btn").on("click",function(){var b=a(this);b.button("loading"),setTimeout(function(){b.button("reset")},3e3)}),a("#exampleModal").on("show.bs.modal",function(b){var c=a(b.relatedTarget),d=c.data("whatever"),e=a(this);e.find(".modal-title").text("New message to "+d),e.find(".modal-body input").val(d)}),a(".bs-docs-activate-animated-progressbar").on("click",function(){a(this).siblings(".progress").find(".progress-bar-striped").toggleClass("active")}),ZeroClipboard.config({moviePath:"/assets/flash/ZeroClipboard.swf",hoverClass:"btn-clipboard-hover"}),a(".highlight").each(function(){var b='<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>';a(this).before(b)});var d=new ZeroClipboard(a(".btn-clipboard")),e=a("#global-zeroclipboard-html-bridge");d.on("load",function(){e.data("placement","top").attr("title","Copy to clipboard").tooltip(),d.on("dataRequested",function(b){var c=a(this).parent().nextAll(".highlight").first();b.setText(c.text())}),d.on("complete",function(){e.attr("title","Copied!").tooltip("fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("fixTitle")})});for(var f=["新能源汽车","金融科技","新零售","智能投顾","一带一路","新三板","A轮","上市公司","外资企业","P2P","创新企业","个人独资","合伙企业","有限责任公司","股份制公司","集团公司","指标性企业","垄断性企业","高风险企业","效益依赖企业","高负债经营企业","银行类","投资类","保险类","信贷业务","证券业务","绿色金融","大型国企","人工智能","无人超市","出海企业","互联网医疗"],g=[],h=0;h<f.length;h++){var i={};i.value=f[h],i.href="",g.push(i)}a("#tagscloud-demo").whaleTagsCloud({tags:g,width:520,radiusX:80,radiusY:200,radiusZ:80});var j={name:"深圳市大疆创新科技有限公司",children:[{name:"深圳市大疆无人机技术有限公司",value:"50.9%",extra:"大股东"},{name:"深圳市大疆灵眸技术有限公司",value:"50.9%"},{name:"深圳市大疆软件科技有限公司",value:"50.9%",children:[{name:"Enos",value:"50.9%"},{name:"Noam",value:"0.9%"}]},{name:"北京大疆文化传媒有限责任公司",value:"50.9%",children:[{name:"Enos",value:"50.9%"},{name:"Noam",value:"50.9%"}]},{name:"上海飞来科技有限公司",value:"0.9%"},{name:"深圳市大疆百旺科技有限公司",value:"0.9%"}]};a("#structure-demo").structure({data:j});var k={vertexes:[{_id:"Company/1",name:"a"},{_id:"Company/2",name:"bao sifjs iaod foia suh foi sudf hoiu"},{_id:"Person/3",name:"c"},{_id:"Company/4",name:"d"}],edges:[{_id:"Invest/1",_from:"Company/1",_to:"Company/2",label:"投资1元"},{_id:"Invest/2",_from:"Company/2",_to:"Company/1",label:"投资2元"},{_id:"Officer/3",_from:"Person/3",_to:"Company/1",label:"董事"},{_id:"Invest/4",_from:"Company/2",_to:"Company/4",label:"投资3元"}]};a("#force-demo").force("init",{data:k,height:300}),whaleRadial({selector:"#radial-demo",width:160,height:160,radius:50,data:{fieldNames:["注册","营收","存款","融资","结算"],values:[[8e4,2e4,3e4,4e4,5e4]]},min:0,max:1e5});var l={name:"Top Level",children:[{name:"Level 2: A"},{name:"Level 2: A"},{name:"Level 2: A",children:[{name:"Son of A"},{name:"Daughter of A"}]},{name:"Level 2: B",children:[{name:"Son of B"},{name:"Daughter of B"}]},{name:"Level 2: A"},{name:"Level 2: A"}]};a("#tree-demo").treeGraph(l),a.get("/assets/json/flare.json").then(function(b){a("#treemap-demo").treemap({data:b,width:650,height:470,onChangePath:function(a){console.log(a)}})}),a("#histogram-demo").histogram({data:[{x:100,time:"2010-7-1"},{x:200,time:"2011-7-1"},{x:300,time:"2012-7-1"},{x:400,time:"2013-7-1"}],xRange:[new Date(2009,7,1),new Date(2014,7,1)],yRange:[0,500],key:"x",label:"x"}),a("#linehistogram-demo").lineHistogram({data:[{x:100,y:2e5,time:"2010-7-1"},{x:200,y:8e5,time:"2011-7-1"},{x:300,y:6e5,time:"2012-7-1"},{x:400,y:4e5,time:"2013-7-1"}],xRange:[new Date(2009,7,1),new Date(2014,7,1)],yLineRange:[0,1e6],yHistoRange:[0,500],lineKey:"y",histoKey:"x",lineLabel:"y",histoLabel:"x",lineLegend:"y",histoLegend:"x"}),["success","warning","danger","positive"].forEach(function(b,c){a("#"+b+"DetailBtn").click(function(){console.log("12345678"),a.whaleAlert(b+"线索信息，可在“我收藏的线索”中看到",{id:"收藏"+c,title:"收藏"+b,position:["top-right",[10,10]],type:b,onNoMoreAlert:function(a){console.log(a)},autoClose:!1})}),a("#"+b+"BasicBtn").click(function(){a.whaleAlert(b+"提示的文案!",{position:["top-right",[10,10]],type:b,isDetail:!1,autoClose:!1})})}),a.whaleAlert("欢迎来到🐳2号");var m={check:{enable:!0},expand:{enable:!0},"class":"new-css-style"},n=[{name:"标签管理",id:1,open:!0,checked:!1,children:[{name:"基本信息",id:11,children:[{name:"用户类型",id:111},{name:"地理信息",id:112,children:[{name:"城市类型",id:1121},{name:"行政区域",id:1122,checked:!0},{name:"住所类型",id:1123,children:[{name:"小区",id:11231},{name:"写字楼",id:11232,open:!0,children:[{name:"租金",id:112321,"class":"租金"}]}]}]},{name:"电视使用",id:113},{name:"内容偏好",id:114}]},{name:"用户群管理",id:12,children:[{name:"经理管理",id:121}]}]},{name:"内容管理",id:2,open:!0,checked:!1},{name:"行情管理",id:3,open:!0,checked:!1}];a("#treeDemo").whaleTree("init",{data:n}),a("#checkTreeDemo").whaleTree("init",{data:n,setting:m}),d.on("noflash wrongflash",function(){a(".zero-clipboard").remove(),ZeroClipboard.destroy()})}),a('.datepicker-section [data-toggle="datepicker"]').each(function(b){a(this).datepicker({trigger:a(a(".datepicker-section .datepicker-trigger")[b]),format:"YYYY-MM-DD",autoHide:!0})}),a('[data-toggle="datepicker"]').on("pick.datepicker",function(a){console.log(a.date)}),a("#datetimepicker").datepicker({showTime:!0,trigger:a("#datetimepickerTrigger"),format:"YYYY-MM-DD hh:mm:ss",autoHide:!0,autoShow:!0,autoPick:!0}),a("#bigCalendar").bigCalendar({date:new Date,schedule:{}}),a("#dropdown-selection-demo").dropdownSelect("init",{placeholder:"请选择",data:[{key:"1",value:"选项1"},{key:"2",value:"选项2"}]}),a(".dropdown-selection-input-demo").whaleDropdownSelect({width:140,data:[{key:1,value:"赵白"},{key:2,value:"钱生"},{key:3,value:"孙丽"}]})}(jQuery),function(){"use strict";anchors.options.placement="left",anchors.add(".bs-docs-section > h1, .bs-docs-section > h2, .bs-docs-section > h3, .bs-docs-section > h4, .bs-docs-section > h5")}(),$("#page").pagination({pageSize:10,total:1e3,prevBtnText:"<",nextBtnText:">"});