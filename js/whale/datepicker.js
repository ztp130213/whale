    ...
    template: (
      '<div class="datepicker-container">' +
        ...
        '<div class="datepicker-panel" data-view="days picker">' +
          ...
          '<div class="operation-bar" data-view="operation-bar">' +
            '<span class="now" data-view="now">现在</span>' +
            '<div class="right-box">' +
              '<span class="toggle" data-view="toggle">选择时间</span>' +
              '<span class="ok" data-view="ok">确定</span>' +
            '</div>' +
          '</div>' +
        '</div>' +
        '<div class="datepicker-panel" data-view="time picker">' +
          '<p class="title"><span>时</span><span>分</span><span>秒</span></p>' +
          '<ul data-view="hours" class="scroll-style"></ul>' +
          '<ul data-view="minutes" class="scroll-style"></ul>' +
          '<ul data-view="seconds" class="scroll-style"></ul>' +
          '<div class="operation-bar" data-view="operation-bar">' +
            '<span class="now" data-view="now">现在</span>' +
            '<div class="right-box">' +
              '<span class="toggle" data-view="toggle">选择日期</span>' +
              '<span class="ok" data-view="ok">确定</span>' +
            '</div>' +
          '</div>' +
        '</div>' +
