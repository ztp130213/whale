...
*/
  ...
  TagsInput.prototype = {
     ...
     */
    add: function (item, key, dontPushVal, options) {
      var self = this;
    ...
    build: function (options) {
      ...
      if (self.options.fuzzySearch) {
        ...
        var optionsContainer = '<div class="tagsinput-options-container" style="width:' + optionsContainerWidth + '">' +
          '<ul class="tagsinput-options-ul">' +
          '</ul>' +
          '</div>';
        var inputwrapperHtml = '<span class="input-wrapper">' +
          optionsContainer +
          '</span>'
        ...
        self.$container.on('click', '.tagsinput-options-container', $.proxy(function (event) {
          ...
          self.add({[self.options.keyUnit]:$item.attr('key'),[self.options.valUnit]:$item.text()},true);
          self.$input.val('');
